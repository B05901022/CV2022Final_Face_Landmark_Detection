...
class ConvBNReLU(nn.Sequential):
    def __init__(self, in_planes, out_planes, kernel_size=3, stride=1, dilation = 1, groups=1, norm_layer=None, activation_layer = nn.ReLU):
...
class InvertedResidual(nn.Module):
    ...
    def __init__(self, cnf: InvertedResidualConfig, norm_layer: Callable[..., nn.Module],
                 se_layer: Callable[..., nn.Module] = CBAMBlock):
        super().__init__()
        ...
        if cnf.expanded_channels != cnf.input_channels:
            layers.append(ConvBNReLU(cnf.input_channels, cnf.expanded_channels, kernel_size=1,
                                           norm_layer=norm_layer, activation_layer=activation_layer))

        # depthwise
        stride = 1 if cnf.dilation > 1 else cnf.stride
        layers.append(ConvBNReLU(cnf.expanded_channels, cnf.expanded_channels, kernel_size=cnf.kernel,
        ...
        # project
        layers.append(ConvBNReLU(cnf.expanded_channels, cnf.out_channels, kernel_size=1, norm_layer=norm_layer,
...
class MobileNetV3(nn.Module):
    ...
    def __init__(
        ...
        layers.append(ConvBNReLU(3, firstconv_output_channels, kernel_size=3, stride=2, norm_layer=norm_layer,
